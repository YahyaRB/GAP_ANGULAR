...
public interface OrdreFabricationService {
		...
		void deleteOrdreFabrication(Long id) throws OrdreFabricationNotFoundException,EmptyResultDataAccessException, IOException;
		Optional<OrdreFabrication> findOFById(Long id) throws OrdreFabricationNotFoundException,EmptyResultDataAccessException;
		...
		OrdreFabrication saveOrdreFabrication(OrdreFabrication ofe) throws IOException, OrdreFabricationNotFoundException, ArticleNotFoundException;
		OrdreFabrication editOf(OrdreFabrication of, Long id)
				throws IOException, OrdreFabricationNotFoundException, EmptyResultDataAccessException, ArticleNotFoundException;
...
//		ResponseEntity<byte[]> generateFicheOf(Long id) throws JRException, IOException, OrdreFabricationNotFoundException;
}
