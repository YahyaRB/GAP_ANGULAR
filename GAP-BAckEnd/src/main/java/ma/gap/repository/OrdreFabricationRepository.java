...
/*	@Query(value = "SELECT id,avancement,quantite FROM ordre_fabrication where avancement<100 and projet_id= :id", nativeQuery = true)
	...
	public List<OrdreFabrication> findAllAvancementaActif(@Param("idProjet") long idProjet,@Param("idAtelier") long idAtelier);
*/
}