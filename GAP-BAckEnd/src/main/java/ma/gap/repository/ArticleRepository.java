...
/*    public List<Article> findAllByprojetAndateliers(Projet projet, Ateliers atelier);*/
    ...
    List<Article> findArticlesByProjetIdAndAtelierId(@Param("projetId") Long projetId, @Param("atelierId") Long atelierId);
